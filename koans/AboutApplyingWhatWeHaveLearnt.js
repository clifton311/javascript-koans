...
describe("About Applying What We Have Learnt", function() {
  ...
  it("given I'm allergic to nuts and hate mushrooms, it should find a pizza I can eat (functional)", function () {
      ...
      var noNuts = array.filter(function(elem){
        return elem.containsNuts === false
      })
      
     noNuts.forEach(function(elem){
        if (!elem.ingredients.includes('mushrooms')){
         productsICanEat.push(elem)
        }
      })
